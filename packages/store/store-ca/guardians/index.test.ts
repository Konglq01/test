...
describe('setGuardiansAction', () => {
  ...
  test('The action.payload exist, userGuardianStatus exist', () => {
    expect(
      reducer(
        {
          verifierMap: mockVerifierMap,
  ...
  test('The action.payload exist, userGuardianStatus does not exist', () => {
    expect(
      reducer(
        {
          verifierMap: mockVerifierMap,
  ...
  test('The action.payload exist, verifierMap is null', () => {
    expect(
      reducer(
        {
          userGuardiansList: [],
